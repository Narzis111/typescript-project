...
function Success() {
  return (
    <div className="grid gap-y-6 text-center">
      ...
      <div>
        <h1 className="mb-4 text-2xl text-white font-extrabold">Register Successfully!</h1>
        <p className="text-white">
          You have successfully regustered your details and now you are ready to go.
        </p>
      </div>
