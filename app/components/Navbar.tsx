...
function Navbar() {
  // const active = "font-bold text-white hover:text-blue-750";
  const active ="font-bold text-white hover:text-blue-750 relative after:absolute after:-bottom-2 after:left-0 after:h-[3px] after:bg-[#FFB200] after:w-full";
  ...
  return (
    <nav className="flex justify-between items-center py-4 px-10 bg-[#CCCCFF] h-[14vh]">
      <div>
