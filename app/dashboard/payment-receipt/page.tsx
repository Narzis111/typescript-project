...
<div>
            ...
            <h3 className="font-semibold text-2xl text-blue-600">Deposit Reciption</h3>
          ...
          <div className="p-6 bg-white">
            ...
            You have paid 500 USD to sbi bank.  <span className="text-[#5296D6]">Your payment status is pending</span> 
            </p>
