...
<div>
            ...
            <h3 className="font-semibold text-2xl text-blue-600">Withdrawal Invoice</h3>
          ...
          <div className="p-6 bg-white">
            <p className="font-semibold text-left">Dear, Mr Jack</p>
            <p className="font-semibold mb-4">
            Your withdrawal amount is 500 USD. <span className="text-[#5296D6]">Your withdrawal status is pending</span> 
            </p>
